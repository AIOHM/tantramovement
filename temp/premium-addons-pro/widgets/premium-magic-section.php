	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore.
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}.pa-link-icon-2'        => '--pa-btn-line6-translate-x: {{SIZE}}px',
					'{{WRAPPER}}.pa-link-icon--1'       => '--pa-btn-line6-translate-x: -{{SIZE}}px',
				),
				'condition' => array(
					'trigger'                             => 'button',
					'premium_magic_section_icon_switcher' => 'yes',
		...
		$this->add_control(
			...
			array(
				...
				'type'        => Controls_Manager::TEXT,
				'description' => __( 'Use the container ID added from container settings -> Advanced tab -> CSS ID ', 'premium-addons-pro' ),
				'condition'   => array(
					'premium_magic_section_content_type' => 'id',
				),
				'ai'          => array(
					'active' => false,
				),
		...
		$this->add_control(
			'container_id_notice',
			array(
				'raw'             => __( 'Use this option to load content from a container on the current page (example: container-1). The container must be added to the page before the Off-Canvas widget.', 'premium-addons-pro' ),
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'       => '{{WRAPPER}}.offcanvas-lottie .premium-msection-btn, {{WRAPPER}}.offcanvas-button .premium-msection-btn:not(.premium-button-style2-shutinhor, .premium-button-style2-shutinver ,.premium-button-style5-radialin, .premium-button-style5-rectin, .premium-button-style8), {{WRAPPER}} .premium-button-style2-shutinhor:before, {{WRAPPER}} .premium-button-style2-shutinver:before, {{WRAPPER}} .premium-button-style5-radialin:before, {{WRAPPER}} .premium-button-style5-rectin:before, {{WRAPPER}} .premium-button-style8',
				'condition'      => array(
		...
		<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'container' ) ); ?>>
			...
			<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'content_wrap' ) ); ?>>
					...
					<div class="premium-msection-content-wrap">
						...
						elseif ( 'id' === $settings['premium_magic_section_content_type'] ) :
							?>
								<div class="premium-msection-content-wrap-template"
