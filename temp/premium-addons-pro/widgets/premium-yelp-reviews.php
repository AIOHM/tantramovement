...
class Premium_Yelp_Reviews extends Widget_Base {
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_control(
			...
			array(
				...
				'type'        => Controls_Manager::TEXT,
				'description' => __( 'Enter language prefix, eg. en for English, ja for Japanese, if you don\'t know your language prefix, please check <a href="https://docs.developer.yelp.com/docs/resources-supported-locales/" target="_blank">here</a>' ),
				'ai'          => array(
					'active' => false,
				),
			)
	...
	protected function render() {
		...
		if ( false === $response || false === $place_response ) {
			...
			$response_reviews = premium_yelp_reviews_data( $api_key, $place_id, $settings['language_prefix'] );
