...
class Premium_Notbar extends Widget_Base {
	...
	protected function is_dynamic_content(): bool {
		...
		$content_type       = $this->get_settings( 'premium_notbar_content_type' );
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_control(
			...
			array(
				...
				'condition'   => array(
					'premium_notbar_type'         => 'notification',
					'premium_notbar_content_type' => 'id',
				),
				'ai'          => array(
					'active' => false,
				),
		...
		$this->add_control(
			'container_id_notice',
			array(
				'raw'             => __( 'Use this option to load content from a container on the current page (example: container-1). The container must be added to the page before the Alert Box widget.', 'premium-addons-pro' ),
				'type'            => Controls_Manager::RAW_HTML,
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
				'condition'       => array(
					'premium_notbar_type'         => 'notification',
				...
				<div class="premium-notbar-icon-text-container">
					...
					<?php if ( 'notification' === $type ) : ?>
						<?php if ( 'editor' === $content_type ) : ?>
							...
							<?php elseif ( 'id' === $content_type ) : ?>
									<div class="premium-notbar-content-wrap-container"
										data-container-id="<?php echo esc_attr( $settings['container_id'] ); ?>">
									</div>
								<?php
							else :
