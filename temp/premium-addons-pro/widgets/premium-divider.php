	...
	private function add_divider_controls( $draw_icon ) {
		...
		$this->add_control(
			...
			array(
				...
				'type'       => Controls_Manager::SELECT,
				'options'    => array(
					'<div></div>'                       => __( 'One', 'premium-addons-pro' ),
					'<div></div><div></div>'            => __( 'Two', 'premium-addons-pro' ),
					'<div></div><div></div><div></div>' => __( 'Three', 'premium-addons-pro' ),
					'<div></div><div></div><div></div><div></div>' => __( 'Four', 'premium-addons-pro' ),
					'<div></div><div></div><div></div><div></div><div></div>' => __( 'Five', 'premium-addons-pro' ),
				),
				'default'    => '<div></div>',
				'conditions' => array(
					'terms' => array(
	...
	private function add_divider_style_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'   => array(
					'{{WRAPPER}} .premium-separator-divider-bg .premium-separator-line' => 'mask-size: {{SIZE}}px 100%; -webkit-mask-size: {{SIZE}}px 100%',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .premium-separator-divider-left .premium-separator-line' => 'border-top-color: {{VALUE}};',
					...
					'{{WRAPPER}} .premium-separator-curvedtop .premium-separator-left-side .premium-separator-line' => 'border-bottom-color: {{VALUE}}',
					'{{WRAPPER}} .premium-separator-shadow .premium-separator-left-side .premium-separator-line,
                    {{WRAPPER}} .premium-separator-shadow .premium-separator-right-side .premium-separator-line' => 'box-shadow: 0 10px 10px -10px {{VALUE}} inset;',
					'{{WRAPPER}} .premium-separator-divider-bg .premium-separator-left-side .premium-separator-line' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'   => array(
					'{{WRAPPER}} .premium-separator-custom .premium-separator-left-side .premium-separator-line' => 'border-image-slice: {{SIZE}} !important;',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'  => '{{WRAPPER}} .premium-separator-shadow .premium-separator-left-side .premium-separator-line',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'  => '{{WRAPPER}} .premium-separator-gradient .premium-separator-left-side .premium-separator-line',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'condition'  => array(
					'left_and_right_separator_type' => array( 'solid', 'shadow', 'gradient' ),
					'left_sep_sw'                   => 'yes',
				),
				'selectors'  => array(
					'{{WRAPPER}} .premium-separator-divider-left .premium-separator-line' =>
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .premium-separator-divider-right .premium-separator-line' => 'border-top-color: {{VALUE}};',
					...
					'{{WRAPPER}} .premium-separator-curvedtop .premium-separator-right-side .premium-separator-line' => 'border-bottom-color: {{VALUE}}',
					'{{WRAPPER}} .premium-separator-shadow .premium-separator-right-side .premium-separator-line' => 'box-shadow: 0 10px 10px -10px {{VALUE}} inset;',
					'{{WRAPPER}} .premium-separator-divider-bg .premium-separator-right-side .premium-separator-line' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'   => array(
					'{{WRAPPER}} .premium-separator-custom .premium-separator-right-side .premium-separator-line' => 'border-image-slice: {{SIZE}} !important;',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'  => '{{WRAPPER}} .premium-separator-shadow .premium-separator-right-side .premium-separator-line',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'  => '{{WRAPPER}} .premium-separator-gradient .premium-separator-right-side .premium-separator-line',
			)
		);
			...
			array(
				...
				$this->add_responsive_control(
					...
					array(
						...
						'selectors'  => array(
							'{{WRAPPER}} .premium-separator-divider-right .premium-separator-line' =>
							'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; overflow: hidden;',
						),
					)
				);
		...
		$this->add_control(
			'left_and_right_separator_height_sep',
			array(
				'type'      => Controls_Manager::DIVIDER,
				'condition' => array(
					'left_and_right_separator_type!' => array(
						'curved',
						'pattern-1',
						'pattern-2',
						'pattern-3',
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'   => array(
					'{{WRAPPER}} .premium-separator-divider-left .premium-separator-line,
                    {{WRAPPER}} .premium-separator-divider-right .premium-separator-line' => 'border-top-width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .premium-separator-curvedtop .premium-separator-left-side .premium-separator-line,
                     {{WRAPPER}} .premium-separator-curvedtop .premium-separator-right-side .premium-separator-line' => 'border-bottom-width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .premium-separator-shadow .premium-separator-left-side .premium-separator-line,
                     {{WRAPPER}} .premium-separator-shadow .premium-separator-right-side .premium-separator-line,
                    {{WRAPPER}} .premium-separator-gradient .premium-separator-left-side .premium-separator-line,
                    {{WRAPPER}} .premium-separator-gradient .premium-separator-right-side .premium-separator-line,
                    {{WRAPPER}} .premium-div-svg .premium-separator-divider-right,
                    {{WRAPPER}} .premium-div-svg .premium-separator-divider-left,
                    {{WRAPPER}} .premium-separator-divider-bg .premium-separator-line' => 'height: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-separator-divider-left .premium-separator-line,{{WRAPPER}} .premium-separator-divider-right .premium-separator-line' => 'margin-top: {{SIZE}}{{UNIT}}; margin-bottom: {{SIZE}}{{UNIT}};',
				),
			)
		);
	...
	private function add_element_style_controls( $draw_icon ) {
		...
		$this->add_control(
			...
			array(
				...
				'condition' => array(
					'content_inside_separator!' => array( 'custom_image', 'animation', 'none' ),
				),
			)
		);
	...
	protected function render() {
		...
		if ( $left_sep || $right_sep ) {
			...
			if ( $has_patterns ) {
				...
				$lines_html  = $settings['content_lines_Number'];
				$lines_count = substr_count( $lines_html, '<div></div>' ); // IMPORTANT: Changed from '<hr>' to '<div></div>'

				$no_of_lines = '';

				for ( $i = 0; $i < $lines_count; $i++ ) {
					$no_of_lines .= '<div class="premium-separator-line" role="separator" aria-orientation="horizontal"></div>';
				}
			}
