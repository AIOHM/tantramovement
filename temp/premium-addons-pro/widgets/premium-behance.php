...
class Premium_Behance extends Widget_Base {
	...
	protected function render() {
		...
		$feed_data = $this->get_behance_feed();

		// Optimization: Slice the feed data to the limit.
		// This significantly reduces the JSON payload size in the HTML.
		if ( isset( $feed_data['projects'] ) && is_array( $feed_data['projects'] ) ) {
			$feed_data['projects'] = array_slice( $feed_data['projects'], 0, $photos_num );
		}
