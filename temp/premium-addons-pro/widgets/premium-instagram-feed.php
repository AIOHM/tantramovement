...
class Premium_Instagram_Feed extends Widget_Base {
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_control(
			...
			array(
				...
				'description' => __( 'Redirect to Photo Link on Instagram', 'premium-addons-pro' ),
				'condition'   => array(
		...
		$this->start_controls_section(
			'premium_instagram_feed_load_more_section',
			array(
		...
		$this->add_control(
			'load_more_initial',
			array(
				'label'       => __( 'Images on Page Load', 'premium-addons-pro' ),
				'type'        => Controls_Manager::NUMBER,
				'default'     => 6,
				'min'         => 1,
				'description' => __( 'Number of images visible before clicking Load More.', 'premium-addons-pro' ),
				'condition'   => array(
					'load_more_btn' => 'yes',
				),
			)
		...
		$this->add_control(
			'load_more_per_click',
			array(
				'label'       => __( 'Images per Click', 'premium-addons-pro' ),
				'type'        => Controls_Manager::NUMBER,
				'default'     => 3,
				'min'         => 1,
				'description' => __( 'Number of images revealed on each Load More click.', 'premium-addons-pro' ),
				'condition'   => array(
					'load_more_btn' => 'yes',
				),
			)
		...
		$this->add_control(
			'load_more_btn_text',
			array(
				'label'       => __( 'Button Label', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
		...
		$this->start_controls_section(
			...
			array(
				...
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'show_videos!' => array( 'redirect', 'none' ),
				),
			)
		);
		...
		$this->start_controls_section(
			'premium_instagram_feed_load_more_style',
			array(
				'label'     => __( 'Load More Button', 'premium-addons-pro' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'   => 'center',
				'selectors' => array(
					'{{WRAPPER}} .premium-instafeed-load-more-wrap' => 'justify-content: {{VALUE}};',
				),
			)
		);

		$this->start_controls_tabs( 'premium_instafeed_lm_tabs' );

		$this->start_controls_tab(
			'premium_instafeed_lm_normal',
			array(
				'label' => __( 'Normal', 'premium-addons-pro' ),
			)
		);
		...
		$this->add_control(
			'premium_instafeed_lm_color',
			array(
				'label'     => __( 'Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-instafeed-load-more-btn' => 'color: {{VALUE}};',
				),
			)
		);

		$this->add_control(
			'premium_instafeed_lm_bg',
			array(
				'label'     => __( 'Background Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-instafeed-load-more-btn' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			array(
				'name'     => 'premium_instafeed_lm_typo',
				'selector' => '{{WRAPPER}} .premium-instafeed-load-more-btn',
			)
		);
		...
		$this->add_group_control(
			Group_Control_Text_Shadow::get_type(),
			array(
				'name'     => 'premium_instafeed_lm_text_shadow',
				'selector' => '{{WRAPPER}} .premium-instafeed-load-more-btn',
			)
		);
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			array(
				'name'     => 'premium_instafeed_lm_border',
				'selector' => '{{WRAPPER}} .premium-instafeed-load-more-btn',
			)
		);

		$this->add_control(
			'premium_instafeed_lm_border_radius',
			array(
				'label'      => __( 'Border Radius', 'premium-addons-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-instafeed-load-more-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			'premium_instafeed_lm_color_hov',
			array(
				'label'     => __( 'Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-instafeed-load-more-btn:hover' => 'color: {{VALUE}};',
				),
			)
		);

		$this->add_control(
			'premium_instafeed_lm_bg_hov',
			array(
				'label'     => __( 'Background Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-instafeed-load-more-btn:hover' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			array(
				'name'     => 'premium_instafeed_lm_typo_hov',
				'selector' => '{{WRAPPER}} .premium-instafeed-load-more-btn:hover',
			)
		);
		...
		$this->add_group_control(
			Group_Control_Text_Shadow::get_type(),
			array(
				'name'     => 'premium_instafeed_lm_text_shadow_hov',
				'selector' => '{{WRAPPER}} .premium-instafeed-load-more-btn:hover',
			)
		);
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			array(
				'name'     => 'premium_instafeed_lm_border_hov',
				'selector' => '{{WRAPPER}} .premium-instafeed-load-more-btn:hover',
			)
		);

		$this->add_control(
			'premium_instafeed_lm_border_radius_hov',
			array(
				'label'      => __( 'Border Radius', 'premium-addons-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-instafeed-load-more-btn:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'separator'  => 'before',
				'selectors'  => array(
					'{{WRAPPER}} .premium-instafeed-load-more-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);

		$this->add_responsive_control(
			'premium_instafeed_lm_margin',
			array(
				'label'      => __( 'Margin', 'premium-addons-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-instafeed-load-more-wrap' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
	...
	protected function render() {
		...
		$load_more           = ( ! empty( $settings['load_more_btn'] ) && 'yes' === $settings['load_more_btn'] && ! $carousel ) ? true : false;
		$load_more_initial   = $load_more && ! empty( $settings['load_more_initial'] ) ? absint( $settings['load_more_initial'] ) : 0;
		$load_more_per_click = $load_more && ! empty( $settings['load_more_per_click'] ) ? absint( $settings['load_more_per_click'] ) : 0;
		$load_more_btn_text  = $load_more && ! empty( $settings['load_more_btn_text'] ) ? $settings['load_more_btn_text'] : __( 'Load More', 'premium-addons-pro' );
		...
		// Optimization: Slice the feed data to the limit if no hashtag filtering is active.
		// This significantly reduces the JSON payload size in the HTML.
		if ( empty( $tags ) && isset( $feed_data['data'] ) && is_array( $feed_data['data'] ) ) {
			$feed_data['data'] = array_slice( $feed_data['data'], 0, $limit );
		}
		...
		$instagram_settings = array(
			...
			'loadMore'         => $load_more,
			'loadMoreInitial'  => $load_more_initial,
			'loadMorePerClick' => $load_more_per_click,
			'lightbox'         => $settings['premium_instagram_feed_popup'],
		);
		...
		<?php else : ?>
			...
			<?php if ( $load_more ) : ?>
				<div class="premium-instafeed-load-more-wrap">
					<button type="button" class="premium-instafeed-load-more-btn">
						<?php echo esc_html( $load_more_btn_text ); ?>
					</button>
				</div>
			<?php endif; ?>
