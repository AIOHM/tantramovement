...
- Tweak: Added new presets for Global Badge addon.
- Tweak: Added Load More button in Instagram Feed widget.
- Tweak: Added Lightbox compatibility with videos in Instagram Feed widget.
- Tweak: Added alt text attribute for images in Instagram Feed widget.
- Fixed: Back icon size control not working in Icon Box widget.
- Fixed: Margin not applied correctly on mobile in Tabs widget.
- Fixed: Navigation from other pages not working in Tabs widget.
- Fixed: Elements styling broken in editor on first-time activation.
- Fixed: Icon Position control not working with SVG icons in Icon Box widget.
- Fixed: Duplicate initialization of Behance Feed widget.

= 2.9.57 =

- Tweak: Added Get Reviews by Language option in Yelp Reviews widget.
- Tweak: Core improved for better performance and loading speed.
- Fixed: Stripe badge not showing in RTL mode.
- Fixed: Team Members widget not working inside Tabs widget.

= 2.9.56 =

- Tweak: Added Container ID option in Image Accordion, Off Canvas, Alert Box and Tabs widgets to get slides from containers on the same page for better usability.
- Tweak: Added Hover Color and Background Color for navigation arrows in social reviews widget.
- Tweak: Border radius option added in Divider widget.
- Tweak: Added Image Fit control for icon in Icon Box widget.
- Tweak: Improved RTL compatibility in Smart Post Listing widget.
- Tweak: Improved compatibility between Unfold and Tabs widgets.
- Fixed: Jittering issues with Snappy effect in Horizontal Scroll widget.

= 2.9.55 =

- New: Animated Gradient and Ken Burns addons are now applicable on widgets.
- Tweak: Opacity Scroll effect in Horizontal Scroll widget improved.
- Fixed: Blob not removed after disabling Animated Blob addon switcher.
...
- Tweak: Added Clipped Background option in Global Badge addon.
- Tweak: Added "p" and "span" options for HTML Tag control in Divider widget.
- Fixed: Image Layers widget not showing when Container Direction is set to row.
- Fixed: Text is showing in multiple lines in Divider widget.
