...
class Premium_Grid_Item extends Widget_Base {
	...
	protected function register_controls() {
		...
		if ( $add_loop_ctrls ) {
			...
			$this->add_control(
				...
				array(
					'raw'             => __( 'Custom Post Skin option requires Elementor PRO ( version 3.8.0 or higher ) & Loop Experiment to be activated.', 'premium-addons-for-elementor' ),
					'type'            => Controls_Manager::RAW_HTML,
					'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning',
				)
			);
	 ...
	 * @since 2.8.20
	 *
	 * @return bool  true if we're in "premium_grid" location.
	 */
