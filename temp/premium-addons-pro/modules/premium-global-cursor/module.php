...
class Module extends Module_Base {
	...
	public function register_controls( $element ) {
		...
		$global_cursor = PAPRO_Helper::get_site_cursor_settings();
	...
	public function post_unpublished( $new_status, $old_status, $post ) {
		...
		if ( 'publish' !== $new_status ) {
			...
			$site_settings = PAPRO_Helper::get_site_cursor_settings();
	...
	public function save_global_cursor_settings( $post_id ) {
		...
		$global_setting = PAPRO_Helper::get_site_cursor_settings();
	...
	public function reset_global_cursor_settings( $post_id ) {
		...
		$cursor_settings = PAPRO_Helper::get_site_cursor_settings();
